...
func TestLoadAuthConfigFromFile_PasswordHashing(t *testing.T) {
	...
	t.Run("username from env variable gets resolved", func(t *testing.T) {
		...
		require.Equal(t, "env.TEST_ADMIN_USERNAME", storedAuth.AdminUserName.SecretVar, "env var reference should be preserved")
	...
	t.Run("password from env variable gets resolved and hashed", func(t *testing.T) {
		...
		require.Equal(t, "env.TEST_ADMIN_PASSWORD", storedAuth.AdminPassword.SecretVar, "password env var reference should be preserved")
	})
	...
	t.Run("both username and password from env variables", func(t *testing.T) {
		...
		// Verify env var reference is preserved after hashing
		require.True(t, storedAuth.AdminPassword.IsFromEnv(), "password should still be marked as from env after hashing")
		require.Equal(t, "env.TEST_ADMIN_PASS", storedAuth.AdminPassword.SecretVar, "password env var reference should be preserved")
	})
	...
	t.Run("env variable not set results in empty value", func(t *testing.T) {
		...
		require.True(t, storedAuth.AdminUserName.IsFromEnv(), "username should be marked as from env")
		require.Equal(t, "env.NONEXISTENT_USERNAME", storedAuth.AdminUserName.SecretVar, "env var reference should be preserved")
		...
		require.Equal(t, "env.NONEXISTENT_PASSWORD", storedAuth.AdminPassword.SecretVar, "env var reference should be preserved")
	})
